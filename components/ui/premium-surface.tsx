...
const premiumSurfaceVariants = cva("relative border text-foreground transition-[background-color,border-color,box-shadow,filter]", {
  variants: {
    tone: {
      ...
      brandPillSubtle:
        "isolate overflow-hidden border-[var(--color-border-brand-pill-subtle)] ds-brand-pill-subtle text-[var(--color-text-brand)] before:pointer-events-none before:absolute before:inset-x-[10%] before:top-[8%] before:h-[38%] before:rounded-[999px] before:bg-[radial-gradient(circle,rgba(255,255,255,0.68)_0%,rgba(255,255,255,0.24)_44%,transparent_80%)] before:blur-lg after:pointer-events-none after:absolute after:inset-0 after:rounded-[inherit] after:shadow-[inset_0_1px_0_var(--color-highlight-brand-pill-subtle)]",
      tintLavender:
