...
import type { StudioDigitalMarketingContent } from "@/components/studio/studio-digital-marketing-content";
import {
  LayoutTemplate,
  LineChart,
  Megaphone,
...
const serviceIconMap: Record<
  StudioDigitalMarketingContent["services"][number]["iconKey"],
  LucideIcon
> = {
  megaphone: Megaphone,
...
// Sizes match the homepage trust strip per-logo visual weight convention.
const dmClientLogos = [
  { name: "NorthSouth Foundation", src: "/logos/nsf.svg", imageClass: "h-14 w-auto max-w-42" },
  { name: "Solitude Farm", src: "/logos/solitude-farm.svg", imageClass: "h-14 w-auto max-w-28" },
  { name: "Rangsutra", src: "/logos/rangsutra.svg", imageClass: "h-14 w-auto max-w-42" },
  { name: "Matrimandir", src: "/logos/matrimandir.svg", imageClass: "h-14 w-auto max-w-42" },
  { name: "TVAM", src: "/assets/tvam/logo.svg", imageClass: "h-14 w-auto max-w-28" },
  { name: "General Aeronautics", src: "/assets/general-aeronautics/logo.svg", imageClass: "h-9 w-auto max-w-32" },
  ...
  return (
    ...
    >
      <div aria-hidden="true" className="pointer-events-none absolute inset-0 z-0">
        <StudioPageRails />
        <div className="absolute inset-x-0 top-0 h-104 bg-[radial-gradient(circle_at_14%_0%,rgba(88,41,199,0.08),rgba(255,255,255,0)_34%),radial-gradient(circle_at_88%_0%,rgba(255,202,45,0.1),rgba(255,255,255,0)_30%)]" />
      </div>
            ...
            <div className="relative z-10 mt-8">
              <StudioPageContainer className="relative md:px-0">
                <div className="relative overflow-hidden">
                  {/* Vertical dividers matching homepage rail edges */}
                  ...
                  <div className="marquee-viewport">
                    <div className="marquee-track py-6">
                      <div className="marquee-group">
                        {dmClientLogos.map((logo) => (
                          <span key={logo.name} className="inline-flex flex-none items-center justify-center">
          ...
          <section className="relative overflow-hidden border-b border-slate-200/80 bg-white py-14 md:py-20">
            ...
            <StudioPageContainer className="relative z-10">
              ...
              >
                <div
                  aria-hidden="true"
                  className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_0%_0%,rgba(88,41,199,0.06),rgba(255,255,255,0)_60%),radial-gradient(circle_at_100%_100%,rgba(255,202,45,0.06),rgba(255,255,255,0)_60%)]"
                />
